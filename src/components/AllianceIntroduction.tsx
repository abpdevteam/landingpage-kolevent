                ...
                <div className="px-4">
                    ...
                    <div className="mt-1 mb-8">
                        ...
                        <div
                            ...
                            <img src="/images/img_87_vtv.png" alt="Event 1"
                    ...
                    <p className="text-center  font-bold " style={{fontFamily: "NeueHelveticaExt, sans-serif"}}>
                        Đơn vị phối hợp truyền thông
                    </p>
                    <div
                        // className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6  justify-items-center"
                        className="flex justify-center gap-4 mt-2 flex-wrap">
                        <img src="/images/logo_final_01_01%20-%20YEAH1%20.png" alt="Event 4"
                             className="w-[100px] h-[50px] mt-8 object-contain"/>
                        <img src="/images/logo_final_02_02%20-%20metub.png" alt="Event 2"
                             className="w-[105px] h-[100px] object-contain"/>
                        <img src="/images/logo_final_03_03%20-%20theanh28trang.png" alt="Event 6"
                             className="w-[100px] h-[100px] object-contain"/>
                        ...
                        <img src="/images/logo_final_06_06%20-%20schannel.png" alt="Event 9"
                             className="w-[100px] h-[100px] object-contain"/>
                        <img src="/images/logo_final_07_07%20-%20kenh14.png" alt="Event 10"
                             className="w-[100px] h-[100px] object-contain"/>
                        <img src="/images/logo_final_08_08%20-%20golden.png" alt="Event 11"
                             className="w-[100px] h-[100px] object-contain"/>
                        <img src="/images/logo_final_09_09%20-%20iSocial.png" alt="Event 12"
                             className="w-[100px] h-[100px] object-contain"/>
                        <img src="/images/logo_final_10_10%20-%20vitamin.png" alt="Event 12"
                             className="w-[100px] h-[100px] object-contain"/>
                    </div>
                    </div>
                </div>
